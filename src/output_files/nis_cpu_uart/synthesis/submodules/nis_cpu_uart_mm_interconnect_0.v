// nis_cpu_uart_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module nis_cpu_uart_mm_interconnect_0 (
	...
	wire  [90:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> spi_0_spi_control_port_agent:cp_data
	...
	wire  [90:0] spi_0_spi_control_port_agent_rp_data;                                      // spi_0_spi_control_port_agent:rp_data -> router_005:sink_data
	...
	nis_cpu_uart_mm_interconnect_0_router router (
	...
	nis_cpu_uart_mm_interconnect_0_router_001 router_001 (
	...
	nis_cpu_uart_mm_interconnect_0_router_002 router_002 (
	...
	nis_cpu_uart_mm_interconnect_0_router_003 router_003 (
	...
	nis_cpu_uart_mm_interconnect_0_router_003 router_004 (
	...
	nis_cpu_uart_mm_interconnect_0_router_003 router_005 (
	...
	nis_cpu_uart_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                   //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	nis_cpu_uart_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_clk_clk),                                          //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	nis_cpu_uart_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nis_cpu_uart_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nis_cpu_uart_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nis_cpu_uart_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nis_cpu_uart_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nis_cpu_uart_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nis_cpu_uart_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nis_cpu_uart_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nis_cpu_uart_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nis_cpu_uart_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nis_cpu_uart_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
